...
- [RBD Procedural Animations in Houdini | Mardini 2026](rbd-procedural-animations-in-houdini-mardini-2026.md) — shares the RBD/Bullet-as-modeling-tool approach, applied there to a barrel-breaking animation with an object-attached glue-strength trigger.
