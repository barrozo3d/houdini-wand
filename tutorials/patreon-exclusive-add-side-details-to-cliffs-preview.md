---
title: Patreon Exclusive  | Add side details to cliffs | Preview
source: YouTube
...
frames_dir: tutorials/frames/patreon-exclusive-add-side-details-to-cliffs-preview/
frame_count: 0
...
**Source:** [YouTube](https://www.youtube.com/watch?v=qzs3LnMeYEE)
**Author:** cgside
**Duration:** 0m16s | 1 section(s)
...
even within a named chapter, verify the real moment against its timestamps), then run:
  python select_frames.py patreon-exclusive-add-side-details-to-cliffs-preview <ts1> <ts2> ...
...
### Summary
16-second preview for a Patreon exclusive on adding side details to procedural cliffs.
