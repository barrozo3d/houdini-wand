...
- [Procedural Modeling tips in houdini #2](procedural-modeling-tips-in-houdini-2.md) — further work on the same tower (tapered extrusion, tile division, dome roof with displacement).
