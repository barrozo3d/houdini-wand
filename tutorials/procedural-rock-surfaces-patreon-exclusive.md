---
title: Procedural Rock Surfaces | Patreon Exclusive
source: YouTube
...
frames_dir: tutorials/frames/procedural-rock-surfaces-patreon-exclusive/
frame_count: 0
...
**Source:** [YouTube](https://www.youtube.com/watch?v=TnujEWlFdfU)
**Author:** cgside
...
even within a named chapter, verify the real moment against its timestamps), then run:
  python select_frames.py procedural-rock-surfaces-patreon-exclusive <ts1> <ts2> ...
...
### Summary
Silent trailer for a Patreon exclusive on procedural rock surfaces.
